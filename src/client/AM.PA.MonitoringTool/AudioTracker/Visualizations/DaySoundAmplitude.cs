...
namespace AudioTracker.Visualizations
{
    class DaySoundAmplitude : BaseVisualization, IVisualization
    {
        private readonly DateTimeOffset _date;

        public DaySoundAmplitude(DateTimeOffset date)
        {
            this._date = date;
        ...
        public override string GetHtml()
        {
            ...
            */
            ...
            html += "<p style='text-align: center; font-size: 0.66em;'>Hint: Displays relative loudness as recorded by the microphone.</p>";
